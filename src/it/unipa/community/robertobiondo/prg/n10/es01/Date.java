...
import it.unipa.community.robertobiondo.prg.n08.es08.*;
...
public class Date implements Comparable<Date>, Cloneable {
    ...
    public Date clone() {
        ...
        try {
            ...
            //Se la data è stata inizializzata correttamente, non c'è il rischio che copiandone i parametri venga
            //lanciata una MyIllegalDateException
        }
        return clone;
    }
    ...
    public boolean equals(Object o) {
        if (Objects.isNull(o) || !(o instanceof Date)) {
            return false;
        }
        Date d = (Date) o;
    ...
    public int hashCode() {
        int hash = 7;
        hash = 71 * hash + this.getGiorno();
        hash = 71 * hash + this.getMese().getIndice();
        hash = 71 * hash + this.getAnno();
        return hash;
    }
}
