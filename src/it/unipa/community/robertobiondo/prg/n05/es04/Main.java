...
public class Main {
    ...
    public static void main(String args[]) {
        ...
        System.out.println(((piano.getValidity()) ? ("I tre punti individuano il piano: " + piano) : ("Almeno due dei tre punti sono uguali oppure"
                + "i tre punti sono allineati e quindi non individuano un piano.")));
