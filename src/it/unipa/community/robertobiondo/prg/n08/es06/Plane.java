...
public class Plane {
    ...
    public Plane(Point3D p1, Point3D p2, Point3D p3) throws MyIllegalPlaneException {
        if (!Vector.linearIndependence((p1.toVector().difference(p2.toVector())), (p3.toVector().difference(p2.toVector())))) {
            throw new MyIllegalPlaneException("The points are colinear and not forming a plane");
        }
        this.p1 = p1;
        this.p2 = p2;
        this.p3 = p3;
